...
import { attachmentKind, validateAttachmentFile, validateNewAttachments } from './attachmentValidation';
...
describe('validateAttachmentFile', () => {
  it('accepts a small JPEG', () => {
    const file = makeFile('question.jpg', 'image/jpeg', 1024);
...
describe('validateNewAttachments', () => {
  ...
  it('accepts files up to MAX_ATTACHMENTS_COUNT and drops the rest, counting files already in the tray', () => {
    ...
    expect(result.accepted[0]).toBe(newFiles[0]); // earliest-selected wins
