// Ported verbatim from client/src/lib/retryCountdown.test.ts.
...
describe('formatRetryWait', () => {
  ...
  it('shows hours and minutes at or above an hour, dropping seconds', () => {
  ...
  it('ceils rather than floors, so a countdown never shows 0s while still waiting', () => {
...
describe('retryMessage', () => {
  it('embeds the formatted wait in a fixed sentence, used consistently everywhere', () => {
