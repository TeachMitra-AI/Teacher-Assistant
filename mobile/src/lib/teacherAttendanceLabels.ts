// Shared plain-language presentation helpers for Teacher Attendance — ported
// verbatim from client/src/lib/teacherAttendanceLabels.ts (pure, no DOM
// dependency). Used across CheckInScreen/HistoryScreen/ReportsScreen so
// wording/formatting can never drift between "today's status", "a past
// day's status", and "the Principal's view of the same day".
