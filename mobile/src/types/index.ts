// Ported verbatim from client/src/types.ts (pure interfaces, zero DOM/React
// dependency — see docs/mobile-app-plan.md §9). Keep in sync manually; there
// is no shared package (§8's CHANGE-11 duplication convention).
