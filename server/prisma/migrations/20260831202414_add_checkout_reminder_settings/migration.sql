...
CREATE TABLE "new_SchoolAttendanceConfig" (
    ...
    "reminderMinutesBeforeClose" INTEGER NOT NULL DEFAULT 15,
    "reminderMinutesAfterClose" INTEGER NOT NULL DEFAULT 30,
...
INSERT INTO "new_SchoolAttendanceConfig" ("checkinWindowEnd", "checkinWindowStart", "closeTime", "createdAt", "earlyDepartureGraceMinutes", "fullDayGraceMinutes", "geofenceLat", "geofenceLon", "geofenceRadiusMeters", "halfDayThresholdPercent", "id", "lateGraceMinutes", "openTime", "repeatPatternThreshold", "repeatPatternWindowDays", "schoolId", "updatedAt", "weeklyOffDays") SELECT "checkinWindowEnd", "checkinWindowStart", "closeTime", "createdAt", "earlyDepartureGraceMinutes", "fullDayGraceMinutes", "geofenceLat", "geofenceLon", "geofenceRadiusMeters", "halfDayThresholdPercent", "id", "lateGraceMinutes", "openTime", "repeatPatternThreshold", "repeatPatternWindowDays", "schoolId", "updatedAt", "weeklyOffDays" FROM "SchoolAttendanceConfig";
